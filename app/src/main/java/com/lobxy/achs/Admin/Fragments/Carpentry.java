...
public class Carpentry extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_carpentry, container, false);

        noComplaints = view.findViewById(R.id.carpentry_text);

        recyclerView = view.findViewById(R.id.re_carpentry);
    ...
    void populateData() {
        ref = FirebaseDatabase.getInstance().getReference().child(complaintType).child(site).child("Carpenter");
