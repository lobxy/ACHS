...
public class Civil extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noComplaints = view.findViewById(R.id.civil_text);

        recyclerView = view.findViewById(R.id.re_civil);

        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        Log.i(TAG, "onCreateView: Site: " + site);
    ...
    void populateData() {
        ref = FirebaseDatabase.getInstance().getReference().child(complaintType).child(site).child("Civil");
