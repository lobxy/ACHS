...
public class HouseKeeping extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_housekeeping, container, false);

        recyclerView = view.findViewById(R.id.re_housekeeping);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        noComplaints = view.findViewById(R.id.house_text);
    ...
    void populateData() {
        ref = FirebaseDatabase.getInstance().getReference().child(complaintType).child(site).child("Housekeeping");
