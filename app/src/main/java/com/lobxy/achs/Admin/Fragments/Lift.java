...
public class Lift extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lift, container, false);

        recyclerView = view.findViewById(R.id.re_lift);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        noComplaints = view.findViewById(R.id.lift_text);
    ...
    void populateData() {
        ref = FirebaseDatabase.getInstance().getReference().child(complaintType).child(site).child("Lift");
