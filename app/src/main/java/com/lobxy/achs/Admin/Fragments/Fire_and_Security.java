...
public class Fire_and_Security extends Fragment {


    public Fire_and_Security() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noComplaints = view.findViewById(R.id.security_text);

        recyclerView = view.findViewById(R.id.re_security);
    ...
    void populateData() {
        ref = FirebaseDatabase.getInstance().getReference().child(complaintType).child(site).child("Fire and Security");
